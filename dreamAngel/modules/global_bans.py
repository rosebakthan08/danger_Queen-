...
import dreamAngel.modules.sql.global_bans_sql as sql
...
from dreamAngel.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from dreamAngel.modules.helper_funcs.misc import send_to_list
from dreamAngel.modules.sql.users_sql import get_user_com_chats
...
def gban(update: Update, context: CallbackContext):
    ...
    if gban_time > 60:
        ...
        message.reply_text("Done! Fuck off.", parse_mode=ParseMode.HTML)
    else:
        message.reply_text("Done! Fuck off.", parse_mode=ParseMode.HTML)
